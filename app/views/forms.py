...
class Question1of6FormView(QuestionFormView):
    ...
    def form_post(self, form):
        ...
        if (
            ...
            and (form.checkbox4.data == result.option4_is_correct)
            and (form.checkbox5.data == result.option5_is_correct)
            and (form.checkbox6.data == result.option6_is_correct)
        ):
            message = "<strong>RICHTIG!</strong>"
            category = "success"
            commit_safely(db.session)
...
class Question3to3FormView(QuestionFormView):
    ...
    def form_post(self, form):
        ...
        if (
            (form.checkbox1a.data == result.option1a_is_correct)
            and (form.checkbox1b.data == result.option1b_is_correct)
            and (form.checkbox1c.data == result.option1c_is_correct)
            and (form.checkbox2a.data == result.option2a_is_correct)
            and (form.checkbox2b.data == result.option2b_is_correct)
            and (form.checkbox2c.data == result.option2c_is_correct)
        ):
            message = "<strong>RICHTIG!</strong>"
            category = "success"
            is_answer_correct = True
...
class Question2DecimalsFormView(QuestionFormView):
    ...
    def form_post(self, form):
        ...
        if (form.value1.data <= result.value1_upper_limit) and (
            form.value1.data >= result.value1_lower_limit
        ):
        ...
        if (form.value2.data <= result.value2_upper_limit) and (
            form.value2.data >= result.value2_lower_limit
        ):
...
class Question1DecimalFormView(QuestionFormView):
    ...
    def form_post(self, form):
        ...
        if (form.value.data <= result.value1_upper_limit) and (
            form.value.data >= result.value1_lower_limit
        ):
...
class QuestionSelect4FormView(QuestionFormView):
    ...
    def form_get(self, form):
        ...
        if question_result is None:
            ...
            external_id = question_result.external_id
            options = {
                "A": question_result.get_option_small_image(
                    question_result.option1_image
                ),
                "B": question_result.get_option_small_image(
                    question_result.option2_image
                ),
                "C": question_result.get_option_small_image(
                    question_result.option3_image
                ),
                "D": question_result.get_option_small_image(
                    question_result.option4_image
                ),
                "E": question_result.get_option_small_image(
                    question_result.option5_image
                ),
                "F": question_result.get_option_small_image(
                    question_result.option6_image
                ),
            }
            error = False
    ...
    def form_post(self, form):
        ...
        if (
            (form.selection1.data == result.selection1_solution.value)
            and (form.selection2.data == result.selection2_solution.value)
            and (form.selection3.data == result.selection3_solution.value)
            and (form.selection4.data == result.selection4_solution.value)
        ):
            message = "<strong>RICHTIG!</strong>"
            category = "success"
            is_answer_correct = True
