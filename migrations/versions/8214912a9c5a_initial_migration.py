...
def downgrade():
    ...
    op.create_table('question_self_assessed',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('external_id', sa.INTEGER(), nullable=True),
    sa.Column('topic_id', sa.INTEGER(), nullable=False),
    sa.Column('description_image', sa.TEXT(), nullable=True),
    ...
    op.create_table('question_select4',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('external_id', sa.INTEGER(), nullable=True),
    sa.Column('topic_id', sa.INTEGER(), nullable=False),
    sa.Column('description_image', sa.TEXT(), nullable=True),
    ...
    sa.CheckConstraint("selection1_solution IN ('A', 'B', 'C', 'D', 'E', 'F')", name='select4enum'),
    sa.CheckConstraint("selection2_solution IN ('A', 'B', 'C', 'D', 'E', 'F')", name='select4enum'),
    sa.CheckConstraint("selection3_solution IN ('A', 'B', 'C', 'D', 'E', 'F')", name='select4enum'),
    sa.CheckConstraint("selection4_solution IN ('A', 'B', 'C', 'D', 'E', 'F')", name='select4enum'),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('question2_decimals',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('external_id', sa.INTEGER(), nullable=True),
    sa.Column('topic_id', sa.INTEGER(), nullable=False),
    sa.Column('description_image', sa.TEXT(), nullable=True),
    ...
    op.create_table('question1_decimal',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('external_id', sa.INTEGER(), nullable=True),
    sa.Column('topic_id', sa.INTEGER(), nullable=False),
    sa.Column('description_image', sa.TEXT(), nullable=True),
