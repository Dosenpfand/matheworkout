...
def upgrade():
    ...
    op.add_column('ab_user', sa.Column('school_type', school_type, nullable=False, server_default='ahs'))
    op.add_column('category', sa.Column('school_type', school_type, nullable=False, server_default='ahs'))
    op.add_column('question', sa.Column('school_type', school_type, nullable=False, server_default='ahs'))
    op.add_column('topic', sa.Column('school_type', school_type, nullable=False, server_default='ahs'))
