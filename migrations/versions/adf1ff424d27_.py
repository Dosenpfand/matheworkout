...
def upgrade():
    ...
    op.add_column('ab_user', sa.Column('account_delete_token', sa.String(length=255), nullable=True))
    op.add_column('ab_user', sa.Column('account_delete_expiration', sa.DateTime(), nullable=True))
