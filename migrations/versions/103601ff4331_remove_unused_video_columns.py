...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('question', sa.Column('video_height', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('question', sa.Column('video_width', sa.INTEGER(), autoincrement=False, nullable=True))
    # ### end Alembic commands ###
